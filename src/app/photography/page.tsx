    ...
    <PageTransition>
      <div className="min-h-screen bg-gray-900 text-white py-24 px-4">
        <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <p className="text-sm text-gray-300 mb-2">{photo.location}</p>
          ...
          {selectedPhoto && (
            ...
            >
              <motion.div
                initial={{ scale: 0.9 }}
                animate={{ scale: 1 }}
                className="max-w-6xl w-full bg-gray-800 rounded-2xl overflow-hidden"
              ...
              >
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="p-8">
                    ...
                    <p className="text-teal-400 mb-4">{selectedPhoto.location}</p>
                    ...
                    <button
                      onClick={() => setSelectedPhoto(null)}
                      className="w-full px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-full hover:from-teal-600 hover:to-cyan-600 transition-all duration-300"
                    >
                      Close
                    </button>
                  </div>
          ...
          >
            <h2 className="text-2xl font-bold text-white mb-4">Interested in a photoshoot?</h2>
            ...
            <a
              ...
              className="inline-block px-8 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white font-semibold rounded-full hover:from-teal-600 hover:to-cyan-600 transform hover:scale-105 transition-all duration-300"
            >
              Get in Touch
            </a>
          </motion.div>
